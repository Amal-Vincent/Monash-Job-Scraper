    ...
    def add_rows_casual(self,job_list):
        ...
        for dic_item in job_list:
                try:
                    ...
                    self.c.execute("INSERT INTO casual VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO fy_recruitment VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO graduate_recruitment VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO professional VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO vacation VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO intern VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO on_campus VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO independent VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
        ...
        for dic_item in job_list:
                try:
                    log.info(dic_item['job_name']+ dic_item['job_org']+ 
                                    dic_item['job_location']+ dic_item['closing_date']+ 
                                    dic_item['job_summary'] )
                    self.c.execute("INSERT INTO vacation_employment VALUES (:jobName, :jobOrg, :jobLocation, :jobDate, :jobSummary)",
                                   {'jobName': dic_item['job_name'],'jobOrg' : dic_item['job_org'],'jobLocation' : 
                                    dic_item['job_location'],'jobDate' : dic_item['closing_date'], 'jobSummary' : 
                                    dic_item['job_summary'] })
                    self.conn.commit()
